...
const DEV_DB_URL =
  'mongodb://mongouser:mongopassword@localhost:27017/gateway?authSource=admin&authMechanism=SCRAM-SHA-256&readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false'
